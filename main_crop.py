...
if __name__ == '__main__':
    # python main_crop.py /work/dong1128/database/radar_uncropped/ <path> --latitude_crop 20 27 --longitude_crop 118 123.5 -k cv
    ...
    parser.add_argument('output_netCDF_path', type=str, help='Output file directory')
